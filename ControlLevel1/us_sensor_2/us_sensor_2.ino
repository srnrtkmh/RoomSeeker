...
ISR(PCINT1_vect) {
  ...
  if (digitalRead(Echo_PIN) == LOW) {
    ...
    Serial.print(", ");
    Serial.println(head_time_2 - head_time_1);
  }
}
  ...
  */
  ...
  if (start_bit == 1) {
    ...
    // 5. 超音波の反射時間を取得できたら
      ...
      echo_dist_val = head_time_2 - head_time_1;
      //    dist[head_index] = echo_dist_val * 0.01657; //how far away is the object in cm
      dist[head_index] = echo_dist_val;
