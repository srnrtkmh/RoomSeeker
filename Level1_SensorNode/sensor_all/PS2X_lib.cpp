...
/****************************************************************************************/
boolean PS2X::read_gamepad(boolean motor1, char motor2) {
...
byte PS2X::config_gamepad(uint8_t clk, uint8_t cmd, uint8_t att, uint8_t dat, bool pressures, bool rumble) {
  ...
  if (PS2data[1] != 0x41 && PS2data[1] != 0x73 && PS2data[1] != 0x79) {
    ...
    Serial.print(PS2data[1]);
    Serial.print("...");
    Serial.print(PS2data[0]);
    Serial.print(",");
    Serial.print(PS2data[1]);
    Serial.print(",");
    Serial.print(PS2data[2]);
    Serial.print(",");
    Serial.print(PS2data[3]);
    Serial.print(",");
    Serial.print(PS2data[4]);
    Serial.print(",");
    Serial.print(PS2data[5]);
    Serial.print(",");
    Serial.print(PS2data[6]);
    Serial.print(",");
    Serial.print(PS2data[7]);
    Serial.print("\n");
#endif
  ...
  for (int y = 0; y <= 10; y++) {
    ...
    if (y == 10) {
      ...
      Serial.print(F("mode stil set at"));
...
void PS2X::sendCommandString(byte string[], byte len) {
  ...
  Serial.println(F("OUT:IN Configure"));
  for (int i = 0; i < len; i++) {
