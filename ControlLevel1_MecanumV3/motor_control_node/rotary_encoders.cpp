...
const uint8_t d2pcint[24] = {16, 17, 18, 19, 20, 21, 22, 23, 0, 1, 2, 3, 4, 5, 8, 9, 10, 11, 12, 13, 0, 0, 0, 0};
#endif
...
uint8_t RotaryEncoders::attach(int n, uint8_t pin1, uint8_t pin2, uint8_t mode) {
  ...
  if (0 <= n && n <= 3) {
    if (pin1 <= 23 && pin2 <= 23) {
      ...
      Serial.print("pin1 = ");
      Serial.print(pin1);
      Serial.print(", d2pcint[pin1] = ");
      Serial.print(d2pcint[pin1]);
      Serial.print(", pin2 = ");
      Serial.print(pin2);
      Serial.print(", d2pcint[pin2] = ");
      Serial.print(d2pcint[pin2]);
      Serial.print("\n");
      Serial.print("\n");
#endif
