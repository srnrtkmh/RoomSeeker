...
#==================================================================================================#
#                                                                                                  #
# FILE : MotorControlTest_v1.py                                                                    #
# Memo : 16/07/18 wxPython03.pyをベースに作成開始                                                  #
#        20/05/05 SignalTraceHostCUI_v2.pyをベースに作成開始                                       #
#                                                                                                  #
# Updated     : 2020/09/18                                                                         #
#               2020/09/20 Wheel velocity command sample                                           #
#                                                                                                  #
#                                                                       (C) 2020 Kyohei Umemoto    #
# How to execute :                                                                                 #
#     python MotorControlTest_v1.py [Serial device name]                                           #
#         or                                                                                       #
#     nohup python MotorControlTest_v1.py [Serial device name] > [tty????.txt] &                   #
#                                                                                                  #
...
if __name__ == '__main__':
  ...
  ctrl_cnt = 0
  ctrl_state = 0
  ctrl_cmd = "vel,000,+1000,+1000,+1000,+1000,end"
    ...
    while True:
      ...
      if ctrl_cnt >= 100:
        ...
        if ctrl_state == 0:
          ...
          ctrl_cmd = "vel,000,+2000,+2000,+2000,+2000,end"
          ctrl_state = 2
        elif ctrl_state == 2:
          ctrl_cmd = "vel,000,+4000,+4000,+4000,+4000,end"
          ctrl_state = 3
        elif ctrl_state == 3:
          ctrl_cmd = "vel,000,+2000,+2000,+2000,+2000,end"
          ctrl_state = 4
          ...
          ctrl_cmd = "vel,000,+0000,+0000,+0000,+0000,end"
          ctrl_state = 0
      ctrl_cnt = ctrl_cnt + 1
