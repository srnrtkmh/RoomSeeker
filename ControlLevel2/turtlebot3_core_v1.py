...
sensor_state_msg = turtlebot3_msgs.msg.SensorState()
version_info_msg = turtlebot3_msgs.msg.VersionInfo()
FIRMWARE_VER = "0.0.0"
pub10cnt = 0
...
def publishSensorStateMsg():
  ...
  # sensor_state_msg.battery = ; # ToDo
  sensor_state_msg.left_encoder = arduino.cnt_now[0]
  sensor_state_msg.right_encoder = arduino.cnt_now[1]
  sensor_state_msg.bumper = 0
  sensor_state_msg.cliff = 0.0;
  # sensor_state_msg.sonar = sensors.getSonarData();    # ToDo
  sensor_state_msg.illumination = 0.0
  sensor_state_msg.led = 0
  sensor_state_msg.button = 0
  sensor_state_msg.torque = False
...
#==================================================================================================#
def publishDriveInformation(void):
  # odometry
  ...
  odom.pose.pose.orientation = tf.createQuaternionFromYaw(arduino.x_res[2]);
...
if __name__ == '__main__':
  ...
  # Publisher settings
  pub = rospy.Publisher('test_pub', String, queue_size=10) # Publisher settings
  sensor_state_pub = rospy.Publisher('sensor_state', turtlebot3_msgs.msg.SensorState, queue_size=10)
  version_info_pub = rospy.Publisher('firmware_version', turtlebot3_msgs.msg.VersionInfo, queue_size=10)
  # imu_pub = rospy.Publisher('imu', , queue_size=10)  # ToDo
