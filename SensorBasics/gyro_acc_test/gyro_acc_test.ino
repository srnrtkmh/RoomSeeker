//================================================================================================//
//                                                                                                //
// FILE : gyro_acc_test.ino                                                                       //
// MEMO : Test program for gyro sensor L3GD20 and ENC-03R, accelerometer LIS3DH                   //
//        Read each sensor value every 10ms -> Transmit the data to serial port                   //
//                                                                                                //
...
// Pin assign :                                                                                   //
//   A0 : ENC-03R #1                            A4(SDA) : L3GD20, LIS3DH SDA                      //
//   A1 : ENC-03R #2                            A5(SCL) : L3GD20, LIS3DH SCL                      //
//   D2 : DHT22                                                                                   //
//                                                                                                //
// Attention :                                                                                    //
//   *L3GD20 SA0 is connected to GND (LSB is zero), CS is connected to Vdd (I2C enabled)          //
//   *LIS3DH SA0 is connected to GND (LSB is zero), CS is pulled up to Vdd (I2C enabled)          //
//                                                                                                //
//================================================================================================//
//================================================================================================//
// Include Files                                                                                  //
