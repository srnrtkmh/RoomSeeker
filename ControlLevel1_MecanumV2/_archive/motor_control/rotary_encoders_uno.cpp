...
uint8_t d2pcint[24] = {16, 17, 18, 19, 20, 21, 22, 23, 0, 1, 2, 3, 4, 5, 8, 9, 10, 11, 12, 13, 0, 0, 0, 0};
...
uint8_t RotaryEncoders::attach(int n, uint8_t pin1, uint8_t pin2){
  uint8_t pin1_pcint = 0, pin2_pcint = 0;
    ...
    if(0 <= n && n <= 3){
      if(0 <= pin1 && pin1 <= 23 && 0 <= pin2 && pin2 <= 23){
