...
#define sensor1   25 // Left   sensor
#define sensor2   27 // center  sensor
#define sensor3   29 // right sensor
...
void tracking()
{
  ...
  if ( senstr == "100")
  {
    ...
    sharpLeftTurn(MID_SPEED, HIGH_SPEED);
  ...
  if (senstr == "001")
  {
    ...
    sharpRightTurn(HIGH_SPEED, MID_SPEED);
